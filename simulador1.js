...
console.log(`Quantidade de repasses por orgãos:`);
console.log(PorOrgaos);

// Orgão com mais repasses de sucesso
...
console.log(`Quantidade de repasses por orgãos de sucesso:`);
console.log(PorOrgaoSucesso);

// Orgãos com mais falhas
...
console.log(`Quantidade de repasses por orgãos com falhas:`);
